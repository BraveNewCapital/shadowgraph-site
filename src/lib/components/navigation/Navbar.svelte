        ...
        <div class="flex justify-end my-auto w-full">
            <div class="hidden sm:block space-x-6 ml-8 h-[60px]">
                ...
                <a class="underline-offset-8 decoration-2 hover:underline" href="/blog">
                    <button class="h-full border-t-2 border-transparent hover:border-[#B4B4B4] w-[80px] transition ease-in-out duration-400">Blog</button>
                </a>
                <a class="underline-offset-8 decoration-2 hover:underline" href="/mission">
                    <button class="h-full border-t-2 border-transparent hover:border-[#B4B4B4] w-[80px] transition ease-in-out duration-400">Mission</button>
                </a>
            </div>
        </div>
        <div class="flex">
